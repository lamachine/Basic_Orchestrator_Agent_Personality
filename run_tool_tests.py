...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Run tests for tool integration system")
    ...
    parser.add_argument("-x", "--fail-fast", action="store_true", help="Exit on first failure")

    parser.add_argument(
        "-l", "--list", action="store_true", help="List available test groups and exit"
    )
