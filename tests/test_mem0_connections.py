...
def test_supabase_connection(mem0_client):
    ...
    memory = mem0_client.create_memory(
        content="Test memory for connection verification", metadata={"test": True}
    )
...
def test_neo4j_connection(mem0_client):
    ...
    # Create two memories
    memory1 = mem0_client.create_memory(content="First test memory", metadata={"test": True})
    memory2 = mem0_client.create_memory(content="Second test memory", metadata={"test": True})
