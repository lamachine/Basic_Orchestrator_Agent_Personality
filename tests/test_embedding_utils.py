...
class TestEmbeddingManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patcher1 = patch(
            "src.sub_graphs.template_agent.src.common.utils.embedding_utils.SentenceTransformer"
        )
        ...
        patcher2 = patch(
            "src.sub_graphs.template_agent.src.common.utils.embedding_utils.torch.cuda.is_available"
        )
    ...
    def test_find_most_similar(self):
        ...
        with (
            patch.object(self.manager, "get_embedding") as mock_get_embedding,
    ...
    def test_find_most_similar_no_matches(self):
        ...
        query_embedding = np.array([1.0, 0.0])
        candidate_embeddings = np.array(
            [[0.1, 0.9], [0.2, 0.8]]  # 0.1 similarity  # 0.2 similarity
        )
    ...
    def test_find_most_similar_high_threshold(self):
        ...
        query_embedding = np.array([1.0, 0.0])
        candidate_embeddings = np.array(
            [[0.9, 0.1], [0.1, 0.9]]  # 0.9 similarity  # 0.1 similarity
        )
