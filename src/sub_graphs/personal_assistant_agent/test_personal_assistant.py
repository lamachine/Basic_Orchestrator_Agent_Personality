...
# from src.sub_graph_personal_assistant.graphs.personal_assistant_graph import personal_assistant_graph  # (disabled for minimal orchestrator)
...
class TestConfig:
    ...
    def validate_google_credentials(self):
        ...
        credentials_path = os.getenv('GOOGLE_CREDENTIALS_FILE', 'C:\\Users\\Owner\\secure_credentials\\google_client_secret.json')
    ...
    def setup(self):
        ...
        os.environ['GMAIL_CREDENTIALS_PATH'] = 'C:\\Users\\Owner\\secure_credentials\\google_client_secret.json'
        os.environ['GOOGLE_CLIENT_SECRET_FILE'] = 'C:\\Users\\Owner\\secure_credentials\\google_client_secret.json'
