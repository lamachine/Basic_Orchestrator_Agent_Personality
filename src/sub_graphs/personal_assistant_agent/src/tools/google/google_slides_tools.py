...
def create_slide(
    presentation_id: str, layout: str = "BLANK", insertion_index: Optional[int] = None
) -> str:
...
def update_slide_background(presentation_id: str, page_id: str, color: Dict[str, float]) -> str:
