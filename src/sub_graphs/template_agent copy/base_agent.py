"""
Base Agent Template - Core functionality for all agent types.
...
class BaseAgent:
    ...
    def __init__(self, 
        ...
        Args:
            name: Agent name
            prompt_section: Agent's role description and instructions
        ...
        self.conversation_history = [] if self.config.get('enable_history', True) else None
    ...
    async def chat(self, user_input: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.config.get('enable_logging', True) and hasattr(self, 'graph_state') and "conversation_state" in self.graph_state:
