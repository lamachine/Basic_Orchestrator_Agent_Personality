...
from ...src.common.config.base_config import (
    BaseConfig, CommonSettings, LLMConfig, LoggingConfig, 
    DatabaseConfig, GraphConfig, AgentConfig, ToolConfig,
    PersonalityConfig, PersonalitiesConfig, DatabaseProvidersConfig,
    SupabaseConfig, PostgresConfig, ModelConfig,
    load_config, get_default_model
)
...
VALID_CONFIG = {
    ...
    "graph": {
        ...
        "edges": [
            {"from": "node1", "to": "node1", "type": "self-loop"}
        ]
    },
    "agent": {
        "enable_history": True,
...
INVALID_CONFIG = {
    ...
    "graph": {
        ...
        "edges": [
            {"from": "node1", "to": "node2", "type": "invalid"}  # node2 doesn't exist
        ]
    },
    "agent": {
        "enable_history": True,
