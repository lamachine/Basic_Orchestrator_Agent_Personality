...
from .state_models import Message, MessageStatus, MessageType, TaskStatus
...
class StateValidator:
    ...
    @staticmethod
    def validate_message_status_transition(
        current_status: MessageStatus, new_status: MessageStatus
    ) -> bool:
