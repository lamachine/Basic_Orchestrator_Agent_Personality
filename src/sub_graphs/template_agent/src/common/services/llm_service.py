...
from ..config.service_config import LLMConfig
...
class LLMService:
    ...
    async def get_response(
        self, system_prompt: str = "", conversation_history: List[Message] = None
    ) -> str:
        """
        ...
        try:
            # Format messages
            formatted_prompt = await self.format_messages(conversation_history or [], system_prompt)
