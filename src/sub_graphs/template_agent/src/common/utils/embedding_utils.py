...
class EmbeddingManager:
    ...
    def find_most_similar(self, query: str, candidates: List[str], threshold: float = 0.5) -> List[Dict[str, Any]]:
        """
    ...
    def batch_similarity(self, queries: List[str], candidates: List[str], threshold: float = 0.5) -> Dict[str, List[Dict[str, Any]]]:
        """
