...
class RagEngine:
    ...
    def __init__(self, memory_manager: Mem0Memory, config: Optional[Dict[str, Any]] = None):
        """
    ...
    def retrieve_context(
        ...
        if not self.memory_manager:
            ...
            return {
                "context": [],
                "metadata": {"success": False, "reason": "No memory manager available"},
            }
        ...
        try:
            ...
            if metadata_filters and results:
                ...
                for result in results:
                    ...
                    is_match = all(
                        result_metadata.get(key) == value for key, value in metadata_filters.items()
                    )
            ...
            return {
                "context": [],
                "metadata": {"success": False, "reason": str(e), "query": query},
            }
    ...
    def store_context(
        ...
        try:
            ...
            message = SwarmMessage(content=content, user_id=user_id, metadata=combined_metadata)
    ...
    def get_conversation_history(
        ...
        try:
            ...
            memories = [
                m for m in memories if m.get("metadata", {}).get("context_type") == "conversation"
            ]
