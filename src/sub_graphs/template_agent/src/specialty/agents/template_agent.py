"""
Template Agent - Example of agent specialization through overrides.
...
class TemplateAgent(OrchestratorAgent):
    ...
    async def update_message_status(self, message: Message, new_status: MessageStatus, **kwargs) -> Message:
        """
    ...
    async def route_request(self, request: Dict[str, Any], tool_name: Optional[str] = None) -> Dict[str, Any]:
        """
