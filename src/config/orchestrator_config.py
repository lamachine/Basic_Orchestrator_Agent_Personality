...
class AgentConfig(BaseModel):
    ...
    librarian: Dict[str, Any] = Field(default_factory=lambda: {'use_web_search': True, 'max_references': 5})
...
def get_orchestrator_config(config_path: str = 'src/config/developer_user_config.yaml') -> OrchestratorConfig:
