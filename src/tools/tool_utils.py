...
from src.state.state_models import GraphState, Message, MessageRole, TaskStatus
...
def execute_tool_with_state(
    ...
    try:
        ...
        state_manager.update_session(
            ...
            metadata={"tool": tool_name, "task": task, "type": "tool_call"},
        )
        ...
        return {"status": "error", "message": error_msg, "data": {"error": str(e)}}
...
def create_tool_node_func(
    tool_name: str, tool_func: Callable[[str], Dict[str, Any]]
