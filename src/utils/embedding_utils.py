...
def get_embedding(
    text: str, model: str = "mock-embedding-model", use_cache: bool = True
) -> List[float]:
...
def batch_get_embeddings(
    texts: List[str], model: str = "mock-embedding-model", use_cache: bool = True
) -> List[List[float]]:
...
def find_similar_vectors(
    query_vector: List[float], vector_list: List[List[float]], top_k: int = 5
) -> List[Dict[str, Any]]:
