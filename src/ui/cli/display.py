...
class CLIDisplay:
                ...
                if "Tool Completion" in content:
                    ...
                    for line in lines:
                        if line.strip() and "Tool:" in line:
                            ...
                            print(f"Result: {line.split('Result:')[1].strip()}", flush=True)
                    print("--------------------", flush=True)
    ...
    def get_user_input(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return MessageFormat.create_request(
                method="user_input",
    ...
    @staticmethod
    def display_formatted(content: Union[str, Dict, List], format_type: str = "default") -> Dict[str, Any]:
